...
shinyUI(fluidPage(
  ...
  tabsetPanel(
             ...
             fluidRow(
               column(
                 ...
                 h4("This learning module provides an introduction to
                    ...
                    basic chromatographic terms and measurements, and on
    ...
    tabPanel("Investigation 1",
             column(
               width = 6,
               h4("Investigation 1: A First Look at a Chromatogram"),
               p(
                 "The figure on the right shows a chromatogram for a
                 ...
                 distribution between the stationary phase and the
                 mobile phase along the column in time intervals of 1 sec."
               ),
               p(
               ...
               p(
                 ...
                 extra peak and what is its significance?"
               ),
               p(
                 "3. The three analytes have different
                 retention times. Why might you reasonably expect
               ...
               p(
                 ...
                 the first analyte to elute. Why might you reasonably
    ...
    tabPanel("Investigation 2",
             column(
               width = 6,
               h4("Investigation 2: A Closer Look at the Separation"),
               p(
               ...
               p(
                ...
                left-to-right, X, Y, and Z, which peak in the column
                view is analyte X? Explain the reason(s) for your
                identification. Check your answer by using the radio
                button to display, in turn, each of the individual analytes."
               ),
               p(
                "2. Select analyte Y using the radio button and move
                the retention time slider from 0 sec to 250 sec in
                several steps of ~50 sec each. What happens to the
                shape of the analyte Y's band in the column view as it
               ...
               p(
                ...
                changes the column view so that it shows analyte Y's
                ...
                a baseline concentration of 0 as shown by the red line.
                Is analyte Y more soluble in the stationary phase or is
                it more soluble in the mobile phase? How do you know this?"
               ),
               p(
                "4. Examine the concentration profiles for
                analyte Y at several different retention times. What do
                the relative shapes of the concentration profiles
                suggest about the process that controls the analyte's
                movement between the mobile phase and the stationary
                phase?"
                ),
               p(
                "5. Examine the the mobile phase and the stationary
               ...
               radioButtons("radio_2a", "display...",
                            choices = c("all analytes", "analyte X",
                                        "analyte Y", "analyte Z"),
    ...
    tabPanel("Investigation 3",
      column(
        width = 6,
        h4("Investigation 3: The Partition Constant and the Retention Factor"),
        p(
        ...
        p(
          ...
          phase
          $${f}_{mp} = \\frac{{\\textrm{(mass X)}}_{mp}}
              {{\\textrm{(mass X)}}_{mp} + {\\textrm{(mass X)}}_{sp}}$$
          where \\(mp\\) indicates the mobile phase and \\(sp\\)
          indicates the stationary phase. Beginning with this equation
          and with your equation for \\(K\\), show that
        ...
        (
          "3. Another way to think about \\({f}_{m}\\) is as
          ...
          Returning to earlier investigations, report the
          retention factor for each of analytes X, Y, and Z."
        )
      ),
      column(
        width = 6,
    ...
    tabPanel("Investigation 4",
      column(
        width = 6,
        h4("Investigation 4: Theoretical Plates"),
        p(
        ...
        equilibrates into the theoretical plate's stationary phase. Third,
        ...
        HTML('<center><img src="cce.png"></center>'),
               ...
               p(
                 "2. One way to increase the number of theoretical plates
                 is to decrease the thickness (more commonly
                 called the height) of the theoretical plates. For each
               ...
               p(
                 ...
                 suggest some physical processes that might explain why an
               ...
               p(
                ...
                Calculate the number of theoretical plates for the last
    ...
    tabPanel("Investigation 5",
             column(
               width = 6,
               h4("Investigation 5: A First Look at Chromatographic Resolution"),
               p(
                "The figure to the right shows two overlapping
                chromatographic peaks for analytes X and Y
                with retention times, peak
               ...
               p(
                ...
                propose several ways that you can improve resolution by
             ...
             column(
               ...
               sliderInput("slider_5a",
                           "X <-- retention times (min) --> Y",
                           min = 7, max = 10, step = 0.01,
                           value = c(8, 9), ticks = FALSE,
                           width = "80%"),
               sliderInput("slider_5b",
                           "X <-- widths at baseline (min) --> Y",
                           min = 0.1, max = 2, step = 0.01,
                           value = c(1.0, 1.2), ticks = FALSE,
                           width = "80%"),
               radioButtons("radio_5a", "relative concentrations: X:Y",
    ...
    tabPanel("Investigation 6",
             column(
               width = 6,
               h4("Investigation 6: A Closer Look at Chromatographic Resolution"),
               p(
                 "In Investigation 5 we learned that we cab express the resolution
                 between two chromatographic peaks as a function of
                 their retention times and their peak widths. Another
                 way to express resolution is shown here
               ...
               h5("Questions"),
               p(
                "1. The three terms in the resolution equation, in
                no particular order, account for the column's
                general retention of analytes, the efficiency with
                which an analyte moves within the mobile phase and
               ...
               p(
                "2. Given this equation for resolution, predict
                whether you can achieve an acceptable resolution for
                this pair of analytes by adjusting the value of
                \\({k}_{b}\\) without
                changing the values of \\(\\alpha\\) and \\(N\\).
                Repeat for \\(\\alpha\\) and for \\(N\\). Explain your
                reasoning in each case and then check your predictions \
                using the sliders."
               ),
               p(
                "3. For each of \\({k}_{b}\\), \\(\\alpha\\), and
               ...
               p(
                ...
                some of which elute earlier than and some of which elute
                later than this pair of analytes, and that \\({k}_{b}\\),
                \\(\\alpha\\), and \\(N\\) may not be independent of each
                other. You can explore the effect of \\({k}_{b}\\),
                \\(\\alpha\\), and \\(N\\) on
    ...
    tabPanel("Investigation 7",
             column(
               width = 6,
               h4("Investigation 7: Improving Resolution Through Efficiency"),
               p(
                "Our equation for resolution suggests that there are
                three broad strategies for optimizing resolution:
                improve efficiency, improve relative selectivity, or
               ...
               p(
                ...
                the contribution to peak width from: multiple pathways,
                as different molecules of the analyte take different paths through
                the stationary phase; longitudinal diffusion, as
                the analyte diffuses from areas of higher concentration
                to areas of lower concentration; and mass transfer,
                as the analytes migrate within the stationary
                phase and the mobile phase, and between the stationary phase and
                the mobile phase at different rates as they try to remain
                at equilibrium. Match each of the terms A, B, and C to the
               ...
               p(
                ...
                the mobile phase, \\({D}_{m}\\), and in the stationary
                ...
                phase's solid support, \\({d}_{p}\\). For each of
                the terms A, B,
                and C, identify the parameter(s) that affect its value.
                Explain your reasoning. Note: a parameter may appear
                in more than one term."
               ),
               p(
                "4. Starting with the van Deemter equation, show that
                the smallest value for H is obtained when
    ...
    tabPanel("Investigation 8",
             column(
               width = 6,
               h4("Investigation 8: Improving Resolution Through Selectivity"),
               p(
                ...
                provide a nearly constant \\({k}_{b}\\) for the last
                analyte to elute."
                ),
               h5("Questions"),
               p(
    ...
    tabPanel("Investigation 9",
             column(
               width = 6,
               h4("Investigation 9: Improving Resolution Through Retention"),
               p(
               ...
               p(
                ...
                solutes elute at 20 sec. What is the expected
               ...
               p(
                ...
                Question 2? Estimate the value of \\(k\\) for the first
                and the last solutes to elute. Repeat using a step gradient."
               ),
               p(
    ...
    tabPanel("Review",
          ...
          HTML("<p>You will find a more detailed discussion of the topics
                ...
                <em>Analytical Chemistry 2.1</em>, which is available
                using this <a href = http://dpuadweb.depauw.edu/harvey_web/eTextProject/version_2.1.html>link</a>.</p>"),
          HTML("<p>A learn module on separation science, written by
               Tom Wenzel at Bates College, is available through
               the Analytical Sciences Digital Library at this
               <a href = http://community.asdlib.org/activelearningmaterials/separation-science/>link</a>.</>"),
          ...
          HTML("Use this <a href = http://www.hplcsimulator.org/>
